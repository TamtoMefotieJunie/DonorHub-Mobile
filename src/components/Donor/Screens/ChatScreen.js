...
function ChatScreen({navigation, route}) {
  ...
  return (
    <>
        <View style={tw`bg-[#333333]/30 p-4 flex flex-row justify-between items-center`}>
             ...
             <View>
             <Text style={tw`text-white text-4 font-semibold`}>{patient.name}</Text>
        ...
        <View style={tw`p-4 h-[90%]`}>
            ...
            <View style={tw`flex flex-row pl-3 justify-between items-center absolute bottom-5 left-0 right-0`}>
                <View style={tw`p-4 rounded-5 bg-[#333333]/30 w-[84%] flex flex-row justify-between items-center`}>
                    <MaterialIcons 
                ...
                <TouchableOpacity style={tw `bg-[#54C2B5] rounded-full m-2 flex flex-row justify-center items-center w-10 h-10`}>
